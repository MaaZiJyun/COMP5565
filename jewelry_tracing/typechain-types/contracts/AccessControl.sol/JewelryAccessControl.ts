...
export interface JewelryAccessControlInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CUTTER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface JewelryAccessControl extends BaseContract {
  connect(runner?: ContractRunner | null): JewelryAccessControl;
  waitForDeployment(): Promise<this>;

  interface: JewelryAccessControlInterface;
